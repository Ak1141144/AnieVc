...
def start_pannel():  
    buttons  = [
            ...
            [ 
                InlineKeyboardButton(text="📨Official Channel", url="https://t.me/JANEMAN_UPDATE"),
                InlineKeyboardButton(text="📨Support Group", url="https://t.me/ALONE_WORLD_OP")
            ],
    ]
...
pstart_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("COMMAND", url=f"https://t.me/JANEMAN_UPDATE/4")],
                [
                    InlineKeyboardButton(
                        "OFFICIAL GROUP", url=f"https://t.me/ALONE_WORLD_OP"), 
                    InlineKeyboardButton(
                        "OFFICIAL CHANNEL", url=f"https://t.me/JANEMAN_UPDATE")
                ],
                [ InlineKeyboardButton("OWNER", url=f"@MR_X_OP_BOLTE"),]
...
⚡️ __Searched Powered By Janeman Music Bot__"""
            link = (x["webpage_url"])
